...
- **@.claude/memory/CLAUDE-active-context.md** - Current session state, goals, and progress (if exists)
- **@.claude/memory/CLAUDE-patterns.md** - Established code patterns and conventions (if exists)
- **@.claude/memory/CLAUDE-decisions.md** - Architecture decisions and rationale (if exists)
- **@.claude/memory/CLAUDE-troubleshooting.md** - Common issues and proven solutions (if exists)
- **@.claude/memory/CLAUDE-temp.md** - Temporary scratch pad (only read when referenced)
